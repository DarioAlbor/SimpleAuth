...
const RemitosClientes = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://portal.drogueriagarzon.com:3001/api/remitos/clientes/guardar', clienteData);
  ...
  const cargarClientes = async () => {
    try {
      const response = await axios.get('https://portal.drogueriagarzon.com:3001/api/remitos/clientes/traer');
  ...
  const handleConfirmEdit = async (clienteId) => {
    try {
      const response = await axios.put(`https://portal.drogueriagarzon.com:3001/api/remitos/clientes/editar/${clienteId}`, editedData);
  ...
  const handleDeleteCliente = async (clienteId) => {
    try {
      const response = await axios.delete(`https://portal.drogueriagarzon.com:3001/api/remitos/clientes/eliminar/${clienteId}`);
