...
const RemitosContainer = ({ generatePDF }) => {
  ...
  useEffect(() => {
    ...
    if (!state.consultasRealizadas) {
      ...
      axios.get('http://portal.drogueriagarzon.com:3001/api/remitos/clientes/traer')
  ...
  const handleFormSubmit = async () => {
    try {
      ...
      const response = await axios.post('http://portal.drogueriagarzon.com:3001/api/remitos/addrto', requestBody, { withCredentials: true });
