...
export default function SetAvatar() {
  ...
  useEffect(async () => {
    if (!localStorage.getItem(process.env.REACT_APP_portal.drogueriagarzon.com_KEY))
      navigate("/login");
  }, []);
  ...
  const setProfilePicture = async () => {
    if (selectedAvatar === undefined) {
      ...
      const user = await JSON.parse(
        localStorage.getItem(process.env.REACT_APP_portal.drogueriagarzon.com_KEY)
      );
      ...
      if (data.isSet) {
        ...
        localStorage.setItem(
          process.env.REACT_APP_portal.drogueriagarzon.com_KEY,
          JSON.stringify(user)
        );
        navigate("/");
      } else {
