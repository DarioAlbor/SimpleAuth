...
const CustomRouter = () => {
    ...
    useEffect(() => {
        const checkAuthentication = async () => {
            try {
                const response = await fetch('https://portal.drogueriagarzon.com:3001/api/user/checkAuthentication', {
                    method: 'GET',
                    credentials: 'include',
                });
        ...
        const fetchUserRole = async () => {
            try {
                const response = await fetch('https://portal.drogueriagarzon.com:3001/api/user/getRole', {
                    method: 'GET',
                    credentials: 'include',
                });
