    ...
    const handleLogout = async () => {
        try {
            await axios.post('http://45.162.169.217:3001/api/logout', null, { withCredentials: true });
          ...
          if (!document.cookie.includes('connect.sid')) {
            ...
            axios
              .all([
                ...
                axios.get('http://45.162.169.217:3001/api/user/getRole', { withCredentials: true }),
              ])
              .then((responses) => {
