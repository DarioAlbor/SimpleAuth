    ...
    const handleLogout = async () => {
        try {
            await axios.post('https://portal.drogueriagarzon.com/api/logout', null, { withCredentials: true });
    ...
    const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
      ...
      const MobileNav = ({ onOpen, handleLogout, handleMenuIconClick, ...rest }: MobileProps) => {
        ...
        useEffect(() => {
          const fetchData = async () => {
            try {
              const response = await axios.get('https://portal.drogueriagarzon.com/api/user/getUsername', { withCredentials: true });
          ...
          if (!document.cookie.includes('connect.sid')) {
            ...
            axios
              .all([
                ...
                axios.get('https://portal.drogueriagarzon.com/api/user/getRole', { withCredentials: true }),
              ])
              .then((responses) => {
